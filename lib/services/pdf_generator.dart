        ...
        build: (context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Text('INVOICE', style: pw.TextStyle(fontSize: 20, fontWeight: pw.FontWeight.bold, decoration: pw.TextDecoration.underline), textAlign: pw.TextAlign.center),
              pw.SizedBox(height: 18),
              ...
              pw.Text('INVOICE', style: pw.TextStyle(fontSize: 14, decoration: pw.TextDecoration.underline), textAlign: pw.TextAlign.center),
              pw.SizedBox(height: 12),
              pw.Table(
                  ...
                  pw.TableRow(
                    ...
                    children: [
                      ...
                      pw.Container(
                        ...
                        padding: const pw.EdgeInsets.all(6),
                        alignment: pw.Alignment.centerRight, // ensures right-aligned inside the container
                        child: pw.Text(
